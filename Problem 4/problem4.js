...
const keyValue = 'age';
const g = new Object();
g.name = window.prompt('Enter your name: ');
g.age = parseInt(window.prompt('Enter your age: '));

// INSERT CODE HERE
let year = 2024;
let hold = g.age;
for(let j=0; j<10; j++){
    console.log(year, g.name, hold);
    hold++;
    year++;
}
alert("You are " + hold + " years old after 10 years");
//UPDATE